...
var aboutBody = '<section class="gr">\n\t<article class="gc g12 bg1 bg-spacing">  \n\t\t<p class="sizel">My name is <a href="http://saarman.net" title="Mart Saarman">Mart Saarman</a>. You can call me Mart, or Mr G. I was born and raised in Estonia, Tallinn. However, life led me away from there back in 2007, and now I reside in Finland, Helsinki.</p>\n\n\t\t<p>I&#39;ve been working as a freelance <a href="http://saarman.net" title="Web Designer">web designer</a> since 2007, utilising the Adobe Creative Suits. In 2010 I also got attached to <a href="http://saarman.net" title="Front-End Javascript Developer">developing Front-End Javascript</a>, bringing the web design alive and interactive with <a href="http://saarman.net" title="Mart Saarman, developing front-end using HTML, CSS and Javascript">HTML, CSS and Javascript.</a></p>\n\t\t<p>When I&#39;m not coloring pixels or coding the matrix, you can find me at f football field shooting few goals or just nibbling grass around Helsinki. I can cook 1 minute meal in 56 seconds.</p> \n\n\t\t<div class="text-box">\n\t\t\t<p>I&#39;m open minded, hard working and always on the lookout for a new challenge or opportunity!</p>\n\t\t</div>\n\t</article>\n</section>\n<section class="gr">\n\t<article class="gc g12">\n\t\t<header class="default">\n\t\t\t<h2>Technical Skills</h2>\n\t\t</header>\n\t\t<div class="content">\n\t\t\t<article class="gc g6 no-spacing">\n\t\t\t\t<div class="skills-list">\n\t\t\t\t\t<h3>Coding</h3>\n\t\t\t\t\t<ul>\n\t\t\t\t\t\t<li>HTML5 & CSS3</li>\n\t\t\t\t\t\t<li>\n\t\t\t\t\t\t\tJavascript, including:\n\t\t\t\t\t\t\t<ul>\n\t\t\t\t\t\t\t\t<li>ReactJS & Flux/Reflux</li>\n\t\t\t\t\t\t\t\t<li>AngularJS</li>\n\t\t\t\t\t\t\t\t<li>NodeJS</li>\n\t\t\t\t\t\t\t\t<li>Socket.IO</li>\n\t\t\t\t\t\t\t\t<li>Promises</li>\n\t\t\t\t\t\t\t\t<li>Highcharts</li>\n\t\t\t\t\t\t\t</ul>\n\t\t\t\t\t\t</li>\n\t\t\t\t\t\t<li>REST API Development</li>\n\t\t\t\t\t</ul>\n\t\t\t\t</div>\n\t\t\t\t<div class="skills-list">\n\t\t\t\t\t<h3>Designing Tools</h3>\n\t\t\t\t\t<ul>\n\t\t\t\t\t\t<li>Adobe Photoshop</li>\n\t\t\t\t\t\t<li>Adobe Illustrator</li>\n\t\t\t\t\t</ul>\n\t\t\t\t</div>\n\t\t\t\t<div class="skills-list">\n\t\t\t\t\t<h3>Various</h3>\n\t\t\t\t\t<ul>\n\t\t\t\t\t\t<li>Broad Knowledge of the following OS systems: Windows, Mac OSX and Linux</li>\n\t\t\t\t\t\t<li>Computer hardware assembly and fixing</li>\n\t\t\t\t\t\t<li>Computer diagnostics</li>\n\t\t\t\t\t\t<li>First-aid (Red Cross)</li>\n\t\t\t\t\t\t<li>Prepare one minute meal in 56 seconds</li>\n\t\t\t\t\t</ul>\n\t\t\t\t</div>\n\t\t\t</article>\n\t\t\t<article class="gc g6 no-spacing">\n\t\t\t\t<div class="skills-list">\n\t\t\t\t\t<h3>Other</h3>\n\t\t\t\t\t<ul>\n\t\t\t\t\t\t<li>Drupal CMS Design & Development</li>\n\t\t\t\t\t\t<li>User Interface and User Experience Design</li>\n\t\t\t\t\t\t<li>Mobile and Tablet Optimization (Responsive)</li>\n\t\t\t\t\t\t<li>WWW-Services Deployment (server-side)</li>\n\t\t\t\t\t\t<li>SEO (Search Engine Optimization)</li>\n\t\t\t\t\t\t<li>Bootstrap</li>\n\t\t\t\t\t\t<li>Foundation</li>\n\t\t\t\t\t\t<li>SCSS +Compass</li>\n\t\t\t\t\t</ul>\n\t\t\t\t</div>\n\t\t\t\t<div class="skills-list">\n\t\t\t\t\t<h3>Software Knowledge</h3>\n\t\t\t\t\t<ul>\n\t\t\t\t\t\t<li>Excel</li>\n\t\t\t\t\t\t<li>Office</li>\n\t\t\t\t\t\t<li>Powerpoint</li>\n\t\t\t\t\t\t<li>Jetbrains Webstorm</li>\n\t\t\t\t\t\t<li>Autodesk Maya (Basic)</li>\n\t\t\t\t\t</ul>\n\t\t\t\t</div>\n\t\t\t\t<div class="skills-list work-in-action">\n\t\t\t\t\t<h3>Work In Action</h3>\n\t\t\t\t\t<div>\n\t\t\t\t\t\t<p>You can see my work behind the scenes. Check out how I\'ve created this portfolio, with all the source files shown at Github.</p>\n\t\t\t\t\t\t<a href="https://github.com/Martastico/personal-portfolio" target="_blank" title="Mart Saarman Github - Personal Portfolio" class="view">View At Github</a>\n\t\t\t\t\t</div>\n\t\t\t\t</div>\n\t\t\t</article>\n\t\t</div>\n\t</article>\n</section>';
